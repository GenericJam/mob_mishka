defmodule MobMishka.Components.MishkaAlertDialog do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaDialog` — same overlay, same anatomy, same part
  ...
  *something* there is what makes it modal.
  ...
  The first three are `MobMishka.Components.MishkaDialog`'s own tags, not
  ...
  `MobMishka.Components.MishkaDialog` for the full table — they are deliberately
  ...
  Everything `MobMishka.Components.MishkaDialog` accepts, except `dismissible`
  ...
  alias MobMishka.Components.{Event, MishkaDialog}
