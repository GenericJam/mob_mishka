defmodule MobMishka.Components.MishkaToggle do
  @moduledoc """
  ...
  apart on purpose:
    ...
    * `MobMishka.Components.MishkaSwitch` — a *setting*. Wraps the platform's
      real switch widget; belongs beside a label in a settings list.
    * `MobMishka.Components.MishkaChip` — a *filter*, one of a set you pick
