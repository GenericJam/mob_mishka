defmodule MobMishka.Components.MishkaActionIcon do
  @moduledoc """
  ...
  A square tap target holding a glyph or nodes. `MobMishka.Components.MishkaCloseButton`
  ...
  any size.
      ...
      iex> MobMishka.Components.MishkaActionIcon.radius(:circle, 40)
      20.0
      iex> MobMishka.Components.MishkaActionIcon.radius(:rounded, 40)
      :radius_md
  """
