defmodule MobMishka.Components.MishkaRadio do
  @moduledoc """
  Native Mob port of Mishka Chelekom's **headless Radio** — one option in a
  mutually exclusive set.

  Same row shape as `MobMishka.Components.MishkaCheckbox`, with the one visual
  ...
  A group of these is `MobMishka.Components.MishkaRadioGroup`'s job; a single
  ...
  `-selected` or `-empty`, the same trick `MobMishka.Components.MishkaCheckbox`
