defmodule MobMishka.Components.MishkaCheckbox do
  @moduledoc """
  ...
  tristate parent, because "some are selected" most usefully becomes "all are".
      ...
      iex> MobMishka.Components.MishkaCheckbox.toggle(%{checked: false})
      {true, false}
      iex> MobMishka.Components.MishkaCheckbox.toggle(%{checked: true})
      {false, false}
      iex> MobMishka.Components.MishkaCheckbox.toggle(%{indeterminate: true})
      {true, false}
  """
