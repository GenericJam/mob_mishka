defmodule MobMishka.Components.MishkaTreeSelect do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaTree`. The tree keeps its own selection and its
  ...
  one — the `:anchored` node (`MobMishka.Components.Anchored`), which
  `MobMishka.Components.MishkaPopover` is built on. A tree select does not use
  ...
  `MobMishka.Components.MishkaDrawer`, which brings a scrim and a dismissal of
  its own.
  ...
  Give the tree inside its own `id` too. `MobMishka.Components.MishkaTree`
  ...
  function for: it is what a form field hands back when it has been cleared.
      ...
      iex> MobMishka.Components.MishkaTreeSelect.display(nil, "Pick one")
      "Pick one"
      iex> MobMishka.Components.MishkaTreeSelect.display("", "Pick one")
      "Pick one"
      iex> MobMishka.Components.MishkaTreeSelect.display("mix.exs", "Pick one")
      "mix.exs"
  """
