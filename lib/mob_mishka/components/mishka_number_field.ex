defmodule MobMishka.Components.MishkaNumberField do
  @moduledoc """
  ...
  trailing `"."` is "not a number yet", not an error.
      ...
      iex> MobMishka.Components.MishkaNumberField.parse("42")
      42
      iex> MobMishka.Components.MishkaNumberField.parse("4.5")
      4.5
      iex> MobMishka.Components.MishkaNumberField.parse("-")
      nil
      iex> MobMishka.Components.MishkaNumberField.parse("")
      nil
      iex> MobMishka.Components.MishkaNumberField.parse("abc")
      nil
  """
  ...
  floating-point noise.
      ...
      iex> MobMishka.Components.MishkaNumberField.step(1, :up, step: 1)
      2
      iex> MobMishka.Components.MishkaNumberField.step(0.3, :up, step: 0.1)
      0.4
      iex> MobMishka.Components.MishkaNumberField.step(nil, :up, step: 1, min: 5)
      5
      iex> MobMishka.Components.MishkaNumberField.step(10, :up, step: 1, max: 10)
      10
  """
  ...
  Render a value for display, at the precision implied by the step.
      ...
      iex> MobMishka.Components.MishkaNumberField.to_text(4, 0)
      "4"
      iex> MobMishka.Components.MishkaNumberField.to_text(4.5, 1)
      "4.5"
      iex> MobMishka.Components.MishkaNumberField.to_text(nil, 0)
      ""
  """
  ...
  The number of decimals a step implies.
      ...
      iex> MobMishka.Components.MishkaNumberField.decimals_for(1)
      0
      iex> MobMishka.Components.MishkaNumberField.decimals_for(0.25)
      2
  """
  ...
  that end of the range.
      ...
      iex> MobMishka.Components.MishkaNumberField.at_bound?(10, :up, max: 10)
      true
      iex> MobMishka.Components.MishkaNumberField.at_bound?(9, :up, max: 10)
      false
      iex> MobMishka.Components.MishkaNumberField.at_bound?(nil, :up, max: 10)
      false
  """
  ...
  number on the screen.
      ...
      iex> MobMishka.Components.MishkaNumberField.format(1999.99, :currency, 2)
      "$1,999.99"
      iex> MobMishka.Components.MishkaNumberField.format(0.075, :percent, 3)
      "7.5%"
      iex> MobMishka.Components.MishkaNumberField.format(42, :plain, 0)
      "42"
      iex> MobMishka.Components.MishkaNumberField.format(nil, :currency, 2)
      ""
  """
