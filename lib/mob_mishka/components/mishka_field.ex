defmodule MobMishka.Components.MishkaField do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaSwitch`, anything.
  ...
  control can tint its own border to match.
      ...
      iex> MobMishka.Components.MishkaField.invalid?(%{errors: ["too short"]})
      true
      iex> MobMishka.Components.MishkaField.invalid?(%{errors: []})
      false
      iex> MobMishka.Components.MishkaField.invalid?(%{errors: [nil, ""]})
      false
  """
