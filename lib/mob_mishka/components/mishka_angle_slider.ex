defmodule MobMishka.Components.MishkaAngleSlider do
  ...
  `MobMishka.Components.MishkaSlider.snap/2`), `disabled`, and `name`/`form`/`id`.
  """
  ...
  otherwise spin the value through a full turn over a few pixels.
      ...
      iex> MobMishka.Components.MishkaAngleSlider.angle_at(80, 10, 160)
      0.0

      iex> MobMishka.Components.MishkaAngleSlider.angle_at(150, 80, 160)
      90.0

      iex> MobMishka.Components.MishkaAngleSlider.angle_at(80, 80, 160)
      :dead
  """
  ...
  back the other way.
      ...
      iex> alias MobMishka.Components.MishkaAngleSlider, as: A
  ...
  Pass `:dead` straight through — there was no angle to follow.
      ...
      iex> MobMishka.Components.MishkaAngleSlider.follow(90.0, :dead)
      90.0
  """
  ...
  Draw ops for the dial at `angle`.
      ...
      iex> ops = MobMishka.Components.MishkaAngleSlider.dial(100, 90, %{})
  ...
  pointing **up** and increasing **clockwise**.
      ...
      iex> MobMishka.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 0)
      {50.0, 10.0}

      iex> MobMishka.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 90)
      {90.0, 50.0}

      iex> MobMishka.Components.MishkaAngleSlider.point_on_dial(50, 50, 40, 180)
      {50.0, 90.0}
  """
