defmodule MobMishka.Components.MishkaToast.Queue do
  @moduledoc """
  The queue behaviour behind `MobMishka.Components.MishkaToast`, as pure
  ...
  key instead of stacking a duplicate).
      ...
      iex> alias MobMishka.Components.MishkaToast.Queue
  ...
  Remove a toast by id.
      ...
      iex> MobMishka.Components.MishkaToast.Queue.dismiss([%{id: 1}, %{id: 2}], 1)
      [%{id: 2}]
  """
