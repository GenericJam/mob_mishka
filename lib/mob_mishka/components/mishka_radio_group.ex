defmodule MobMishka.Components.MishkaRadioGroup do
  @moduledoc """
  Native Mob port of Mishka Chelekom's **headless Radio Group** — a labelled set
  of mutually exclusive options.

  Composes `MobMishka.Components.MishkaRadio` rather than redrawing the circle,
  ...
  `"plan-pro-empty"` — see `MobMishka.Components.MishkaRadio` for why the state
  ...
  alias MobMishka.Components.MishkaRadio
  ...
  cleared by re-tapping, which is exactly where it differs from a checkbox.
      ...
      iex> MobMishka.Components.MishkaRadioGroup.select(:a, :b)
      :b
      iex> MobMishka.Components.MishkaRadioGroup.select(:a, :a)
      :a
      iex> MobMishka.Components.MishkaRadioGroup.select(nil, :a)
      :a
  """
