defmodule MobMishka.Components.MishkaMenu do
  @moduledoc """
  Native Mob port of Mishka Chelekom's **headless Menu** — a list of actions
  revealed from a trigger.

  Builds on `MobMishka.Components.MishkaPopover.panel/2`, so a menu and a popover
  ...
  dropdown, or inside a `MobMishka.Components.MishkaDrawer` for a bottom-sheet
  ...
  (`MobMishka.Components.Anchored`). The menu has not been moved onto it, and it
  ...
  | plus everything `MobMishka.Components.MishkaPopover` accepts | | | |
  ...
  overlays do exist now — `MobMishka.Components.Anchored`, which `popover`,
  ...
  alias MobMishka.Components.{Event, MishkaPopover}
