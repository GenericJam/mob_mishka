defmodule MobMishka.Components.MishkaAnchor do
  @moduledoc """
  ...
  the screen's business:
    ...
    * an external URL → `MobMishka.Components.MishkaAnchor.open/1`, which wraps
  ...
  `MobMishka.Components.MishkaScroller` follows. `on_tap` therefore carries the
  ...
  component should never hand an arbitrary string to the platform's URL opener.
      ...
      iex> MobMishka.Components.MishkaAnchor.open("ftp://example.com")
      :error

      iex> MobMishka.Components.MishkaAnchor.open(nil)
      :error
  """
