defmodule MobMishka.Components.MishkaTagsInput do
  @moduledoc """
  ...
  Composes `MobMishka.Components.MishkaPill` for the tokens (each with its own
  ...
  alias MobMishka.Components.{Event, MishkaPill}
  ...
  Trims, ignores blanks, and refuses duplicates unless `allow_duplicates: true`.
      ...
      iex> MobMishka.Components.MishkaTagsInput.add(["a"], "b")
      ["a", "b"]
      iex> MobMishka.Components.MishkaTagsInput.add(["a"], "  a  ")
      ["a"]
      iex> MobMishka.Components.MishkaTagsInput.add(["a"], "   ")
      ["a"]
      iex> MobMishka.Components.MishkaTagsInput.add(["a"], "a", allow_duplicates: true)
      ["a", "a"]
  """
  ...
  Remove a tag.
      ...
      iex> MobMishka.Components.MishkaTagsInput.remove(["a", "b"], "a")
      ["b"]
  """
  ...
  a row to itself rather than being dropped.
      ...
      iex> MobMishka.Components.MishkaTagsInput.wrap(["a", "b"], 28)
      [["a", "b"]]
      iex> MobMishka.Components.MishkaTagsInput.wrap(["aaaaaaaa", "bbbbbbbb", "cccccccc"], 20)
      [["aaaaaaaa"], ["bbbbbbbb"], ["cccccccc"]]
      iex> MobMishka.Components.MishkaTagsInput.wrap([], 28)
      []
  """
