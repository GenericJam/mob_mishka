defmodule MobMishka.Components.MishkaScroller do
  @moduledoc """
  ...
  The scrolling itself is `MobMishka.Components.MishkaScrollArea` (Mob's native
  ...
  alias MobMishka.Components.{MishkaActionIcon, MishkaScrollArea}
  ...
  text query has no business hunting for. These are the handles.
      ...
      iex> MobMishka.Components.MishkaScroller.arrow_ids("gallery")
