defmodule MobMishka.Components.Anchored do
  @moduledoc """
  ...
  it is what lets `MobMishka.Components.MishkaPopover`,
  `MobMishka.Components.MishkaTooltip` and
  `MobMishka.Components.MishkaPreviewCard` behave like their Chelekom originals
