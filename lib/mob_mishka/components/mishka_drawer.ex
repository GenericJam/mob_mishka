defmodule MobMishka.Components.MishkaDrawer do
  @moduledoc """
  ...
  (`MobMishka.Components.Anchored`, which `popover` and friends put their panel
  ...
  **Verified on Android (Samsung A55, One UI / Android 15)** — all four sides
  ...
  `MobMishka.Components.MishkaMenu.item/3` returns a `<MishkaMenuItem>`: pass it
  ...
  exactly as it was:
      ...
      iex> alias MobMishka.Components.MishkaDrawer
  ...
  measure the viewport, so the caller states what the fraction is of.
      ...
      iex> MobMishka.Components.MishkaDrawer.snap_heights(%{snap_points: [440, 180]})
      [180, 440]

      iex> MobMishka.Components.MishkaDrawer.snap_heights(%{snap_points: [0.4, 0.76], extent: 500})
      [200.0, 380.0]
  ...
  `expand/3` logs it) rather than silently rendering a 0.4dp sheet:
      ...
      iex> MobMishka.Components.MishkaDrawer.snap_heights(%{snap_points: [0.4, 300]})
      [300]
  """
  ...
  cannot say which snap point produced it.
      ...
      iex> MobMishka.Components.MishkaDrawer.snap_index(%{snap_points: [180, 300], snap: 300})
      2

      iex> MobMishka.Components.MishkaDrawer.snap_index(%{snap_points: [180, 300]})
      1
  """
  ...
  edge when it is not given.
      ...
      iex> MobMishka.Components.MishkaDrawer.dismiss_direction(%{side: :bottom})
      :down

      iex> MobMishka.Components.MishkaDrawer.dismiss_direction(%{side: :bottom, swipe_direction: :right})
      :right
  """
