defmodule MobMishka.Components.MishkaToast do
  @moduledoc """
  ...
  give it**, and `MobMishka.Components.MishkaToast.Queue` provides the queue
  ...
  **A static item cannot dismiss itself.** It lives in the render tree, never in
  ...
  alias MobMishka.Components.{Event, MishkaActionIcon}
