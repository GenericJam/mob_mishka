defmodule MobMishka.Components.MishkaHighlight do
  @moduledoc """
  ...
  `Text`, matched runs through `MobMishka.Components.MishkaMark`.
  ...
  `MobMishka.Components.MishkaOverflowList` makes with `visible`. Leave it unset
  ...
  `MobMishka.Components.MishkaMark` and `Text` directly; that is what the mark is
  for, and the web component draws the same line (it has one `mark_class`).
  """

  import Mob.Sigil

  alias MobMishka.Components.MishkaMark
  ...
  searched for.
      ...
      iex> MobMishka.Components.MishkaHighlight.split("Mishka Chelekom", "chel")
      [{:text, "Mishka "}, {:mark, "Chel"}, {:text, "ekom"}]

      iex> MobMishka.Components.MishkaHighlight.split("This and THIS", "this")
      [{:mark, "This"}, {:text, " and "}, {:mark, "THIS"}]

      iex> MobMishka.Components.MishkaHighlight.split("This and THIS", "this", case_sensitive: true)
      [{:text, "This and THIS"}]

      iex> MobMishka.Components.MishkaHighlight.split("one two", [])
      [{:text, "one two"}]

      iex> MobMishka.Components.MishkaHighlight.split("one two", ["", nil])
      [{:text, "one two"}]
  """
  ...
  invisible, rather than being carried down as an indent.
      ...
      iex> alias MobMishka.Components.MishkaHighlight
