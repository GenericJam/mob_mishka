defmodule MobMishka.Components.MishkaSegmentedControl do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaToggleGroup` instead.
  ...
  rather than an empty state.
      ...
      iex> MobMishka.Components.MishkaSegmentedControl.select(:a, :b)
      :b
      iex> MobMishka.Components.MishkaSegmentedControl.select(:a, :a)
      :a
  """
