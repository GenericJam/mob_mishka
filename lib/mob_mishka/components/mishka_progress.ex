defmodule MobMishka.Components.MishkaProgress do
  @moduledoc """
  ...
  indeterminate. Exposed because it is the whole of the range logic.
      ...
      iex> MobMishka.Components.MishkaProgress.fraction(%{value: 50})
      0.5
      iex> MobMishka.Components.MishkaProgress.fraction(%{value: 3, max: 5})
      0.6
      iex> MobMishka.Components.MishkaProgress.fraction(%{value: 999})
      1.0
      iex> MobMishka.Components.MishkaProgress.fraction(%{})
      nil
      iex> MobMishka.Components.MishkaProgress.fraction(%{value: "72"})
      0.72
  """
