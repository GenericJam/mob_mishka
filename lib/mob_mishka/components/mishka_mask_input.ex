defmodule MobMishka.Components.MishkaMaskInput do
  @moduledoc """
  ...
  **significant characters only**, discarding literals before re-laying them out,
  ...
  the user.
      ...
      iex> MobMishka.Components.MishkaMaskInput.apply_mask("5551234567", "(999) 999-9999")
      "(555) 123-4567"

      iex> MobMishka.Components.MishkaMaskInput.apply_mask("(555) 123-4567", "(999) 999-9999")
      "(555) 123-4567"

      iex> MobMishka.Components.MishkaMaskInput.apply_mask("555", "(999) 999-9999")
      "(555"

      iex> MobMishka.Components.MishkaMaskInput.apply_mask("abc1234", "aaa-9999")
      "abc-1234"

      iex> MobMishka.Components.MishkaMaskInput.apply_mask("", "99/99")
      ""
  """
  ...
  The characters a mask would keep from a value — the unformatted payload.
      ...
      iex> MobMishka.Components.MishkaMaskInput.strip("(555) 123-4567")
      "5551234567"
  """
  ...
  literals included, since that is what the field displays.
      ...
      iex> MobMishka.Components.MishkaMaskInput.max_length("99/99/9999")
      10

      iex> MobMishka.Components.MishkaMaskInput.max_length(nil)
      0
