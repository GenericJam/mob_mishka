defmodule MobMishka.Components.MishkaTree do
  @moduledoc """
  ...
  *is* data — a directory listing, a category table — `Enum.map/2` into `nodes`
  ...
  alias MobMishka.Components.MishkaCheckbox
  ...
  `:has_children`.
      ...
      iex> MobMishka.Components.MishkaTree.node("mix.exs", "mix.exs", icon: "📄")
      %{label: "mix.exs", value: "mix.exs", icon: "📄"}

      iex> MobMishka.Components.MishkaTree.node("lib", "lib",
      ...>   children: [MobMishka.Components.MishkaTree.node("app.ex", "lib/app.ex")])
  ...
  shorthand the web attr takes.
      ...
      iex> MobMishka.Components.MishkaTree.visible(nodes, [])
      [{%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}, 0, true, false}]

      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.visible(nodes, ["a"]) |> Enum.map(&elem(&1, 0).value)
      ["a", "b"]

      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.visible(nodes, :all) |> Enum.map(&elem(&1, 0).value)
      ["a", "b"]
  ...
  applies to.
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.subtree_values(nodes, "a")
      ["a", "b"]

      iex> MobMishka.Components.MishkaTree.subtree_values([], "a")
      []
  """
  ...
  only some of its descendants are checked.
      ...
      iex> MobMishka.Components.MishkaTree.check_state(nodes, "a", ["b"])
      :indeterminate

      iex> nodes = [%{label: "a", value: "a", children: [
      ...>   %{label: "b", value: "b"}, %{label: "c", value: "c"}]}]
      iex> MobMishka.Components.MishkaTree.check_state(nodes, "a", ["b", "c"])
      :checked

  A leaf is simply checked or not:

      iex> MobMishka.Components.MishkaTree.check_state([%{label: "b", value: "b"}], "b", ["b"])
      :checked
  ...
  the prop inert — the tick landed in the list and the box stayed empty.
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.check_state(nodes, "a", ["a"], strictly: true)
      :checked

      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.check_state(nodes, "a", ["a"])
      :unchecked
  """
  ...
  node.
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.toggle_check(nodes, "a", [])
      ["a", "b"]

      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.toggle_check(nodes, "a", ["a", "b"])
      []

      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.toggle_check(nodes, "a", [], strictly: true)
      ["a"]
  ...
  reads as unchecked forever and every tap tries to check it again.
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.toggle_check(nodes, "a", ["a"], strictly: true)
      []
  """
  ...
  `has_children: true` and has not fetched them yet.
      ...
      iex> MobMishka.Components.MishkaTree.expanded_values(nodes)
      ["a", "c"]
  """
  ...
  Expand or collapse `value` in an expanded list.
      ...
      iex> MobMishka.Components.MishkaTree.toggle_expand("a", [])
      ["a"]

      iex> MobMishka.Components.MishkaTree.toggle_expand("a", ["a", "b"])
      ["b"]
  ...
  with `expanded_values/1` first, so the tap really does close a branch.
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]}]
      iex> MobMishka.Components.MishkaTree.toggle_expand("a", :all, nodes)
      []
  """
  ...
  same "tap it again to put it back" the disclosure has:
      ...
      iex> MobMishka.Components.MishkaTree.toggle_select("a", [])
      ["a"]

      iex> MobMishka.Components.MishkaTree.toggle_select("b", ["a"])
      ["b"]

      iex> MobMishka.Components.MishkaTree.toggle_select("a", ["a"])
      []

  With `multiple: true` a tap adds or removes, and the rest stays:

      iex> MobMishka.Components.MishkaTree.toggle_select("b", ["a"], multiple: true)
      ["a", "b"]

      iex> MobMishka.Components.MishkaTree.toggle_select("a", ["a", "b"], multiple: true)
      ["b"]
  """
  ...
  the middle of a range rather than joining it.
      ...
      iex> MobMishka.Components.MishkaTree.select_range(nodes, ["a"], "b", "d")
      ["b", "c", "d"]

      iex> nodes = [%{label: "a", value: "a", children: [
      ...>   %{label: "b", value: "b"}, %{label: "c", value: "c"}]}, %{label: "d", value: "d"}]
      iex> MobMishka.Components.MishkaTree.select_range(nodes, ["a"], "d", "b")
      ["b", "c", "d"]
  ...
  be dragged across:
      ...
      iex> nodes = [%{label: "a", value: "a", children: [%{label: "b", value: "b"}]},
      ...>   %{label: "d", value: "d"}]
      iex> MobMishka.Components.MishkaTree.select_range(nodes, [], "a", "d")
      ["a", "d"]

  With no anchor yet — nothing selected — a hold is just a selection of one:

      iex> MobMishka.Components.MishkaTree.select_range([%{label: "a", value: "a"}], [], nil, "a")
      ["a"]
  """
  ...
  The test tag on a whole row — the tap and long-press target.
      ...
      iex> MobMishka.Components.MishkaTree.row_tag("files", "lib/app.ex")
  ...
  The test tag on a row's disclosure.
      ...
      iex> MobMishka.Components.MishkaTree.toggle_tag("files", "lib")
      "files-toggle-lib"
  """
  ...
  The test tag on a row's checkbox.
      ...
      iex> MobMishka.Components.MishkaTree.check_tag("files", "lib")
      "files-check-lib"
  """
  ...
  its own tag instead.
      ...
      iex> MobMishka.Components.MishkaTree.state_tag("files", "lib", "open")
      "files-lib-open"
  """
