defmodule MobMishka.Components.MishkaColorInput do
  @moduledoc """
  ...
  (`MobMishka.Components.Anchored`), which
  `MobMishka.Components.MishkaPopover` is built on. The picker does not use it,
  ...
  through typing (see the note on `MobMishka.Components.Color.hsv_to_hex/3`).
  ...
  alias MobMishka.Components.{Color, Event, MishkaColorPicker}
  ...
  does not — which is the normal state for most of the time someone is typing.
      ...
      iex> MobMishka.Components.MishkaColorInput.commit("#ff0000")
      {:ok, {0, 100, 100}}

      iex> MobMishka.Components.MishkaColorInput.commit("#ff00")
      :incomplete
  """
