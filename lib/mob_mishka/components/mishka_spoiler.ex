defmodule MobMishka.Components.MishkaSpoiler do
  @moduledoc """
  ...
  They share a mechanism and differ in intent, which changes the markup:
    ...
    * `MobMishka.Components.MishkaCollapsible` hides content behind a **titled
  ...
  The control's label for a state — the whole of the "changes as it works" rule.
      ...
      iex> MobMishka.Components.MishkaSpoiler.label(%{}, false)
      "Show more"
      iex> MobMishka.Components.MishkaSpoiler.label(%{}, true)
      "Show less"
      iex> MobMishka.Components.MishkaSpoiler.label(%{show_label: "Read on"}, false)
      "Read on"
  """
