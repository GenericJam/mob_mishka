defmodule MobMishka.Components.MishkaAutocomplete do
  @moduledoc """
  ...
  So this renders through `MobMishka.Components.MishkaCombobox` (same filtering,
  ...
  (`MobMishka.Components.Anchored`) does float a panel in its own window, and
  `MobMishka.Components.MishkaPopover` is built on it. The suggestions stay in
  ...
  alias MobMishka.Components.MishkaCombobox
  ...
  already matches one exactly.
      ...
      iex> alias MobMishka.Components.MishkaAutocomplete, as: A
  ...
  nothing left to suggest.
      ...
      iex> MobMishka.Components.MishkaAutocomplete.exact?(["Iran"], "iran")
      true
      iex> MobMishka.Components.MishkaAutocomplete.exact?(["Iran"], "ir")
      false
      iex> MobMishka.Components.MishkaAutocomplete.exact?(["Iran"], "")
      false
  """
  ...
  Whether `suggestion` is exactly what the query already says.
      ...
      iex> MobMishka.Components.MishkaAutocomplete.exact_match?("Iran", "iran")
      true
      iex> MobMishka.Components.MishkaAutocomplete.exact_match?("Ireland", "iran")
      false
  """
