defmodule MobMishka.Components.MishkaSelect do
  @moduledoc """
  ...
  `:anchored` node (`MobMishka.Components.Anchored`) draws a panel in its own
  window, against the anchor's own bounds and clipped by no ancestor, and
  `MobMishka.Components.MishkaPopover` is built on it.
  ...
  put the same options inside a bottom `MobMishka.Components.MishkaDrawer`,
  ...
  alias MobMishka.Components.{Event, MishkaMenu}
  ...
  the order rather than having it sorted underneath them.
      ...
      iex> alias MobMishka.Components.MishkaSelect
  ...
  a multi-select that closed after every pick would be exhausting.
      ...
      iex> MobMishka.Components.MishkaSelect.toggle(nil, :a, false)
      {:a, true}
      iex> MobMishka.Components.MishkaSelect.toggle(:a, :a, false)
      {:a, true}
      iex> MobMishka.Components.MishkaSelect.toggle([:a], :b, true)
      {[:a, :b], false}
      iex> MobMishka.Components.MishkaSelect.toggle([:a, :b], :a, true)
      {[:b], false}
  """
  ...
  The text a trigger shows for a value.
      ...
      iex> MobMishka.Components.MishkaSelect.display(nil, [], "Pick one")
      "Pick one"
      iex> MobMishka.Components.MishkaSelect.display(:a, [{:a, "Alpha"}], "Pick one")
      "Alpha"
      iex> MobMishka.Components.MishkaSelect.display([:a, :b], [{:a, "Alpha"}, {:b, "Beta"}], "x")
      "Alpha, Beta"
      iex> MobMishka.Components.MishkaSelect.display([], [{:a, "Alpha"}], "Pick one")
      "Pick one"
  """
