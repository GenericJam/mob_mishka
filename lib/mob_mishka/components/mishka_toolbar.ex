defmodule MobMishka.Components.MishkaToolbar do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaToggle` or a
  `MobMishka.Components.MishkaToggleGroup` beside its own items — it invents no
  ...
  the strip's Box. `overflow` names what to do instead:
    ...
    * `:collapse` — keep `visible` controls and put a `⋯` at the end, which
      ...
      `MobMishka.Components.MishkaDrawer`. `split/2` is the whole policy, pure
      and testable.
  ...
  *announced* name, which is the gap the hint works around.
  ...
  description, not an effect.
      ...
      iex> alias MobMishka.Components.MishkaToolbar
  ...
  untagged.
      ...
      iex> MobMishka.Components.MishkaToolbar.item_tag("fmt", :bold, false)
      "fmt-bold"

      iex> MobMishka.Components.MishkaToolbar.item_tag("fmt", :bold, true)
      "fmt-bold-disabled"

      iex> MobMishka.Components.MishkaToolbar.item_tag(nil, :bold, false)
      nil
  """
  ...
  place it survives.
      ...
      iex> MobMishka.Components.MishkaToolbar.group_tag("fmt", "Text align")
      "fmt-group-text-align"

      iex> MobMishka.Components.MishkaToolbar.group_tag("fmt", nil)
      nil
  """
  ...
  The test tag on the `⋯`.
      ...
      iex> MobMishka.Components.MishkaToolbar.overflow_tag("fmt")
      "fmt-overflow"
  """
  ...
  The test tag on the hint caption.
      ...
      iex> MobMishka.Components.MishkaToolbar.hint_tag("fmt")
      "fmt-hint"
  """
  ...
  without a finger.
      ...
      iex> MobMishka.Components.MishkaToolbar.scroll_tag("fmt")
      "fmt-scroll"
  """
