defmodule MobMishka.Components.MishkaCheckboxGroup do
  @moduledoc """
  ...
  Composes `MobMishka.Components.MishkaCheckbox` for both the children and the
  ...
  `MobMishka.Components.MishkaCheckbox`.
  ...
  Add or remove `id` from the selection, preserving order.
      ...
      iex> MobMishka.Components.MishkaCheckboxGroup.toggle([:a], :b)
      [:a, :b]
      iex> MobMishka.Components.MishkaCheckboxGroup.toggle([:a, :b], :a)
      [:b]
  """
  ...
  asking to be completed, not emptied.
      ...
      iex> MobMishka.Components.MishkaCheckboxGroup.select_all([], [:a, :b])
      [:a, :b]
      iex> MobMishka.Components.MishkaCheckboxGroup.select_all([:a], [:a, :b])
      [:a, :b]
      iex> MobMishka.Components.MishkaCheckboxGroup.select_all([:a, :b], [:a, :b])
      []
  """
  ...
  The `{checked?, indeterminate?}` the parent should render for a selection.
      ...
      iex> MobMishka.Components.MishkaCheckboxGroup.parent_state([], [:a, :b])
      {false, false}
      iex> MobMishka.Components.MishkaCheckboxGroup.parent_state([:a], [:a, :b])
      {false, true}
      iex> MobMishka.Components.MishkaCheckboxGroup.parent_state([:a, :b], [:a, :b])
      {true, false}
  """
