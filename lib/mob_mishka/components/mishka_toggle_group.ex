defmodule MobMishka.Components.MishkaToggleGroup do
  @moduledoc """
  ...
  Composes `MobMishka.Components.MishkaToggle`, so a lone toggle and a grouped
  ...
  Every styling prop `MobMishka.Components.MishkaToggle` takes — `color`,
  ...
  the note in `MobMishka.Components.MishkaToggle`.
  ...
  alias MobMishka.Components.MishkaToggle
  ...
  group, which keeps its selection.
      ...
      iex> MobMishka.Components.MishkaToggleGroup.press(nil, :a, false)
      :a
      iex> MobMishka.Components.MishkaToggleGroup.press(:a, :a, false)
      nil
      iex> MobMishka.Components.MishkaToggleGroup.press(:a, :b, false)
      :b
      iex> MobMishka.Components.MishkaToggleGroup.press([:a], :b, true)
      [:a, :b]
      iex> MobMishka.Components.MishkaToggleGroup.press([:a, :b], :a, true)
      [:b]
  """
  ...
  Whether `id` is pressed for a given value, in either mode.
      ...
      iex> MobMishka.Components.MishkaToggleGroup.pressed?(:a, :a)
      true
      iex> MobMishka.Components.MishkaToggleGroup.pressed?([:a, :b], :b)
      true
      iex> MobMishka.Components.MishkaToggleGroup.pressed?(nil, :a)
      false
  """
