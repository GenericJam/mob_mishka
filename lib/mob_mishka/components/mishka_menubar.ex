defmodule MobMishka.Components.MishkaMenubar do
  @moduledoc """
  ...
  (`MobMishka.Components.Anchored`), which `MobMishka.Components.MishkaPopover`
  is built on — and the menubar has simply not been moved onto it. It draws
  through `MobMishka.Components.MishkaMenu`, which is unchanged. `:anchored` is
  ...
  `MobMishka.Components.MishkaMenu`).
  """
  ...
  never leaving two open.
      ...
      iex> MobMishka.Components.MishkaMenubar.open_menu(:file, nil)
      :file

      iex> MobMishka.Components.MishkaMenubar.open_menu(:file, :file)
      nil

      iex> MobMishka.Components.MishkaMenubar.open_menu(:edit, :file)
      :edit
  """
