defmodule MobMishka.Components.MishkaPopover do
  @moduledoc """
  ...
  `MobMishka.Components.Anchored` is what replaced it. The trigger is child `[0]`
  ...
  default, which is how `MobMishka.Components.MishkaMenu` — passing none, and
  ...
  **long press**, the same touch equivalent
  `MobMishka.Components.MishkaContextMenu` uses for the web's right-click. The
  ...
  whatever owns the screen root — use `MobMishka.Components.MishkaDialog` or
  `MobMishka.Components.MishkaDrawer` when the page must be blocked),
  ...
  alias MobMishka.Components.Anchored
