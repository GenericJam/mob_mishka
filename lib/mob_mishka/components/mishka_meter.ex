defmodule MobMishka.Components.MishkaMeter do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaProgress.fraction/1` for the range maths rather
  ...
  alias MobMishka.Components.MishkaProgress
  ...
  web component's `--chelekom-meter` custom property.
      ...
      iex> MobMishka.Components.MishkaMeter.ratio(%{value: 72})
      0.72
      iex> MobMishka.Components.MishkaMeter.ratio(%{})
      0.0
  """
