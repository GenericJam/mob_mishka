defmodule MobMishka.Components.MishkaAlphaSlider do
  @moduledoc """
  ...
  `MobMishka.Components.MishkaSlider` for why.
  """
  ...
  The inverse of the marker, so finger and marker cannot separate.
      ...
      iex> MobMishka.Components.MishkaAlphaSlider.alpha_at(150, 300)
      50.0

      iex> MobMishka.Components.MishkaAlphaSlider.alpha_at(300, 300)
      100.0

      iex> MobMishka.Components.MishkaAlphaSlider.alpha_at(-40, 300)
      0.0
  """
  ...
  the position marker.
      ...
      iex> ops = MobMishka.Components.MishkaAlphaSlider.track(32, 16, {255, 0, 0}, 50)
