defmodule MobMishka.Components.MishkaAutocompleteTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.{MishkaAutocomplete, MishkaPillsInput}

  doctest MobMishka.Components.MishkaAutocomplete
