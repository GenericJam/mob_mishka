...
defmodule MobMishka.Components.MishkaCheckboxGroupTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.MishkaCheckboxGroup, as: Group
  ...
  doctest MobMishka.Components.MishkaCheckboxGroup
