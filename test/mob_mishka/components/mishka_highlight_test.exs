defmodule MobMishka.Components.MishkaHighlightTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.{MishkaHighlight, MishkaMark}

  doctest MobMishka.Components.MishkaHighlight
