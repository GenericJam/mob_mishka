defmodule MobMishka.Components.ColorControlsTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.{
    Color,
    MishkaAlphaSlider,
    MishkaAngleSlider,
    MishkaColorInput,
  ...
  doctest MobMishka.Components.MishkaHueSlider
  doctest MobMishka.Components.MishkaAlphaSlider
  doctest MobMishka.Components.MishkaAngleSlider
  doctest MobMishka.Components.MishkaColorPicker
  doctest MobMishka.Components.MishkaColorInput
  ...
  # bridges; see the note in the upstream showcase suite.
