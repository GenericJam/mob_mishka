defmodule MobMishka.Components.MishkaSegmentedControlTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  import Mob.Sigil

  alias MobMishka.Components.MishkaSegmentedControl, as: SC

  doctest MobMishka.Components.MishkaSegmentedControl
