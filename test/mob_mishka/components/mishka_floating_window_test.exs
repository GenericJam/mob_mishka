# credo:disable-for-this-file Jump.CredoChecks.WeakAssertion
# Rationale: inherited from upstream port (MOB-249)
defmodule MobMishka.Components.MishkaFloatingWindowTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  import Mob.Sigil

  alias MobMishka.Components.{MishkaFloatingIndicator, MishkaFloatingWindow}

  doctest MobMishka.Components.MishkaFloatingWindow
  doctest MobMishka.Components.MishkaFloatingIndicator
