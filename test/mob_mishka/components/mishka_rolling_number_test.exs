defmodule MobMishka.Components.MishkaRollingNumberTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.MishkaRollingNumber

  doctest MobMishka.Components.MishkaRollingNumber
