defmodule MobMishka.Components.MishkaToastTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.MishkaToast
  alias MobMishka.Components.MishkaToast.Queue

  doctest MobMishka.Components.MishkaToast.Queue
