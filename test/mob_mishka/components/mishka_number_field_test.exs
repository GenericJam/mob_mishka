defmodule MobMishka.Components.MishkaNumberFieldTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.MishkaNumberField, as: NF

  doctest MobMishka.Components.MishkaNumberField
