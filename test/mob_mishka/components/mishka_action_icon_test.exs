defmodule MobMishka.Components.MishkaActionIconTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.{MishkaActionIcon, MishkaCloseButton}

  doctest MobMishka.Components.MishkaActionIcon
