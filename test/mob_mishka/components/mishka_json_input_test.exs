defmodule MobMishka.Components.MishkaJsonInputTest do
  # async: false — Mob.ScreenCase starts the globally-named `Mob.State`.
  use Mob.ScreenCase, async: false

  alias MobMishka.Components.{MishkaJsonInput, MishkaNumberFormatter}

  doctest MobMishka.Components.MishkaJsonInput
  doctest MobMishka.Components.MishkaNumberFormatter
